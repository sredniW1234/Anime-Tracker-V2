...
func default_themes(theme:String):
	...
	elif theme == "Neon Cyber":
		disabled_color = Color("1a1c22")
		background_color = Color("0f1115") 
		normal_color = Color("1a1c22") 
		normal_elevated_color = Color("232632") 
		accent_color = Color("00e5ff") 
		progress_bar_fill_color = Color("7c4dff") 
		primary_font_color = Color("e6f1ff") 
		disabled_font_color = Color("5c6370") 
		tab_unselected_font_color = Color("8a90a6")
	elif theme == "test":
		disabled_color = Color("1a2016")
		background_color = Color("11150e") 
		normal_color = Color("1f2619") 
		normal_elevated_color = Color("2c3524") 
		accent_color = Color("a3ff12") 
		progress_bar_fill_color = Color("c0ff4d") 
		primary_font_color = Color("f2ffe6") 
		disabled_font_color = Color("6f8a5c") 
		tab_unselected_font_color = Color("9fba84")
